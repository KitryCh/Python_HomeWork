...
n = int (input ("Введите количество учеников первого класса: "))
m = int (input ("Введите количество учеников второго класса: "))
o = int (input ("Введите количество учеников третьего класса: "))
print((n + 1) // 2 + (m + 1) // 2 + (o + 1) // 2)